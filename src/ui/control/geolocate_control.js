 ...
 * @instance
 * @property {Position} data [Geolocation.getCurrentPosition()](https://developer.mozilla.org/en-US/docs/Web/API/Geolocation/getCurrentPosition) 或者 [Geolocation.watchPosition()](https://developer.mozilla.org/en-US/docs/Web/API/Geolocation/watchPosition)的回调返回的[Position](https://developer.mozilla.org/en-US/docs/Web/API/Position)对象.
 *
 */
 ...
 * @memberof GeolocateControl
 * @instance
 * @property {PositionError} data [Geolocation.getCurrentPosition()](https://developer.mozilla.org/en-US/docs/Web/API/Geolocation/getCurrentPosition) 或者 [Geolocation.watchPosition()](https://developer.mozilla.org/en-US/docs/Web/API/Geolocation/watchPosition)的回调返回的[PositionError](https://developer.mozilla.org/en-US/docs/Web/API/PositionError)对象.
 *
 */
